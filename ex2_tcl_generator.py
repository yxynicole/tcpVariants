...
def main(cmd_line_args):
    ...
    template = open('ex2.template').read()
    ...
    script_content = template.format(
        ...
        tcp_4_5_start_time=cmd_line_args.tcp_4_5_start_time,
        tcp_4_5_stop_time=cmd_line_args.tcp_4_5_stop_time,
    )

    open("ex2.tcl", "w").write(script_content)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tcp_4_5_start_time',type=int, default=0)
    parser.add_argument('--tcp_4_5_stop_time', type=int, default=10)
